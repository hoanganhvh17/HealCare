...
public class DoctorDashboardController {
    ...
    public String doctorDashboard(
        ...
        Map<String, DoctorInsightDTO> insights = doctorInsightService.buildDashboardInsights(insightStats);
    ...
    // Không còn `/doctor/api/quick-review-advice`: nội dung ô "AI Insight" nay được dựng ngay
    // trong doctorDashboard() qua DoctorInsightService và in thẳng ra Thymeleaf. Route cũ là
    // bản sao y hệt của DoctorAiController.getQuickReviewAdvice và chưa từng có ai gọi tới.
}